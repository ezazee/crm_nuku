...
<head>
        <meta charset="utf-8" />
        <title>Transaksi Belanjain | NusantaraKu Dashboard Admin</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Transaksi Belanjain Setiap Mitra Kabupaten</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td>
                                                                <form action="#" >
                                                                    <a class="btn btn-primary waves-effect btn-label waves-light btn-sm" href="{{ route('belanjain.details') }}">Detail</a>
                                                                </form>
                                                            </td>
                                                        </tr>
