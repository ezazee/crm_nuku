                            ...
                            <div class="col-lg-7 col-md-10 col-sm-11">
                                ...
                                <div class="horizontal-steps mt-4 mb-4 pb-3" id="tooltip-container">
                                    <div class="horizontal-steps-content">
                                        ...
                                        <div class="step-item">
                                            <span data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="20/09/2022 09:24 PM">Diantar Ke Jasa Kirim</span>
                                        </div>
                                        <div class="step-item">
                                            <span data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="20/09/2022 10:24 PM">Diantar Ke Alamat Tujuan</span>
                                        </div>   
                         ...
                         <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li>
                                                <p class="mb-2"><span class="fw-bold me-2">Kurir : </span> Citra Van Titipan Kilat  </p>
                                                <p class="mb-2"><span class="fw-bold me-2">Tipe Layanan : </span> Reguler </p>
                                                <p class="mb-2"><span class="fw-bold me-2">Estimas Tiba : </span> 05 Jan 2023 10:26:42 </p>
                                                <p class="mb-2"><span class="fw-bold me-2">Tanggal Dikirim : </span> 02 Jan 2023 10:26:42 </p>
                                            </li>
                                        </ul>
                             ...
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">Pelacakan Pesanan</h4>

                                            <div class="text-center">
                                                <h3> Kode Pemabayran : XjcLYFXjcLYFXjcLYF </h3>
                                            </div>
